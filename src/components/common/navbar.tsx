    ...
    <nav className="bg-white py-3 px-4 mb-6">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center">
          ...
          <span className="text-blue-500 font-semibold">career.ly</span>
        </Link>
        ...
        <div className="flex items-center">
          ...
          <span className="ml-2 text-sm font-medium hidden sm:inline">John Doe</span>
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 bg-gray-100 rounded-lg p-4">
          <div className="flex flex-col space-y-2">
            <Link 
              href="/" 
              className={`px-4 py-2 rounded-lg text-sm ${pathname === '/' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-200'}`}
            ...
            <Link 
              href="/pekerjaan" 
              className={`px-4 py-2 rounded-lg text-sm ${pathname === '/pekerjaan' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-200'}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Pekerjaan
            </Link>
            ...
            <Link 
              href="/komunitas" 
              className={`px-4 py-2 rounded-lg text-sm ${pathname === '/komunitas' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-200'}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Komunitas
            </Link>
            <Link 
              href="/pelatihan" 
              className={`px-4 py-2 rounded-lg text-sm ${pathname === '/pelatihan' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-200'}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Pelatihan
            </Link>
