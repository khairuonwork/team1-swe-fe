  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 flex items-center justify-center min-h-screen">
      <div className="flex flex-col w-full">
        ...
        <div className="mb-8">
          <p className="mb-2 font-medium">Pertanyaan <span className="font-bold">1/8</span></p>
          <h1 className="text-3xl font-bold mb-8">Aktivitas apa yang paling kamu nikmati saat punya waktu luang?</h1>
